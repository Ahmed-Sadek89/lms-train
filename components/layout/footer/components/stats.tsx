...
const Stats = () => {
    return (
        <section className='app-container border-b border-b-gray-50/10'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-34 justify-between items-center'>
                <div className='flex flex-col gap-4 lg:gap-y-[32px] items-start'>
                    <h3 className='lg:font-heading-3'>
                ...
                <div className='flex items-center justify-between w-full gap-[24px] flex-wrap'>
                    <div className='flex flex-col items-start gap-2 lg:gap-y-[12px]'>
